...
public class Fpage2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<p align = 'center'>"+ "REGISTRATION FORM" +"</p>");
		...
		out.println("<p align ='justify'>Height: " + HEIGHT + " cm" +"</p>");
		...
		out.println("<p align ='justify'>Complexion: " + COMPLEXION + "</p>");
		...
		out.println("<p align = 'center'>If you want to make a change</p>");
	    ...
	    out.println("<p align = 'center'>This is Final</p>");
